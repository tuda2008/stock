$(function() {
  ...
  var rowItem = '<tr class="stock_companies ' + tr_class + '">'
                ...
                + '<td class="col">' + sum_stock_stockholders_num.toFixed(0) + '</td>'
                + '<td class="col">' + sum_stock_holders_buy_sum_price.toFixed(1) + '</td>'
                + '<td class="col">' + sum_stock_ransom_sum_price.toFixed(1) + '</td>'
                + '<td class="col"></td>'
                + '<td class="col"></td>'
                + '</tr>';
